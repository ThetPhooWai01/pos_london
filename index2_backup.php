...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
            ...
            $stmt->bind_param("ssssssssss", $today, $barcode, $product_name, $pieces_price, $qty, $pieces_price, $random,$customer,$payment, $type, $date, $orderNumber);
            if ($stmt->execute()) {
                $errorMessage = "update_data success";
            } else {
                $errorMessage = "Error: " . $stmt->error;
          ...
          <form id="dataForm">
            ...
            <tr class="table-column label-mb">
              ...
              if ($result->num_rows > 0) {
                ...
                <td class="td-reduce-padding w-100"><input class="w-100" type="text" name="rate"  id="orderNumber" readonly value="'.$last_voucher.'"></td>         
              </tr>
              ...
              <td class="td-reduce-padding w-100">
                <select class="w-100" id='payment' name='payment'>
              ...
              <td class="td-reduce-padding w-100">
                <select class="w-100" id='customer' name='customer'>
