...
if (isset($_POST['update'])) {
    ...
    $profit = $_POST['profit'];
    $sql = "update 'product' set no=$id,barcode='$barcode',product_name='$product_name',
      buy='$buy',package_price='$package_price',profit='$profit' where no=$id";
        ...
        <form method="POST" action="update_product.php">
            <table>
              <tr class="table-column label-mb ">
                ...
                <td class="td-reduce-padding w-100"><input class="w-250" type="text" name="barcode" value=<?php echo $barcode; ?>></td>
              </tr>
              <tr class="table-column label-mb">
                <td class="td-reduce-padding "><p class="text-nowrap label">ပစ္စည်းအမည်:</p></td>
                <td class="td-reduce-padding w-100"><input class="w-250" type="text" name="product_name" value=<?php echo $product_name; ?>></td>
              </tr>
              <tr class="table-column label-mb">
                <td class="td-reduce-padding "><p class="text-nowrap label">ကဒ်အရေအတွက်:</p></td>
                <td class="td-reduce-padding w-100"><input class="w-250" type="text" name="unit_count" value=<?php echo $product_name; ?>></td>
              </tr>
              <tr class="table-column label-mb">
                <td class="td-reduce-padding "><p class="text-nowrap label">ဗူးအရေအတွက် :</p></td>
                <td class="td-reduce-padding w-100"><input class="w-250" type="text" name="pieces_count" value=<?php echo $product_name; ?>></td>
              </tr>
              <tr class="table-column label-mb">
                <td class="td-reduce-padding "><p class="text-nowrap label">ဝယ်ဈေး :</p></td>
                <td class="td-reduce-padding w-100"><input class="w-50" type="text" name="purchase_price" value=<?php echo $product_name; ?>>
              ...
              <tr class="table-column label-mb">
                ...
                <td class="td-reduce-padding w-100"><input class="w-50" type="text" name="money_rate" value=<?php echo $product_name; ?>>
                    <select name="ငွေဈေးနှုန်း" id="cars" class="w-20">
