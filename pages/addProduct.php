...
if (isset($_POST['add'])) {
    ...
    $pieces_count = $_POST['pieces_count'];
    $purchase_price = $_POST['purchase_price'];
    //  $purchase_kyat = $_POST['purchase_kyat'];
    //  $purchase_baht = $_POST['purchase_baht'];
    //  $purchase_yuan = $_POST['purchase_yuan'];

    $money_rate = $_POST['money_rate'];
    //  $kyat_rate = $_POST['kyat_rate'];
    //  $baht_rate = $_POST['baht_rate'];
    //  $yuan_rate = $_POST['yuan_rate'];

    $deli_fee = $_POST['deli_fee'];
    //  $p_price = $_POST['p_price'];
    //  $c_price = $_POST['c_price'];
    //  $b_price= $_POST['b_price'];
    $expire_date = $_POST['expire_date'];
    $profit = $_POST['profit'];
    $package_price = (($purchase_price / $money_rate) + $deli_fee) + $profit;
    $round_package_price = ceil($package_price);
    $unit_price = $package_price / $unit_count;
    $pieces_price = $unit_price / $pieces_count;

    $sql = "INSERT INTO product (barcode, product_name, unit, pieces, buy, currency, trans,exp_date, profit,package_price,round_package_price,unit_price,pieces_price)
	 VALUES ('$barcode','$product_name','$unit_count','$pieces_count','$purchase_price','$money_rate','$deli_fee','$expire_date','$profit','$package_price',
   '$round_package_price','$unit_price','$pieces_price')";
        ...
        <form method="POST" action="addProduct.php">
            <table>
              <tr class="table-column label-mb ">
                ...
                <td class="td-reduce-padding w-100"><input class="w-250" type="text" name="barcode"></td>
              </tr>
              <tr class="table-column label-mb">
                <td class="td-reduce-padding "><p class="text-nowrap label">ပစ္စည်းအမည်:</p></td>
                <td class="td-reduce-padding w-100"><input class="w-250" type="text" name="product_name"></td>
              </tr>
              <tr class="table-column label-mb">
                <td class="td-reduce-padding "><p class="text-nowrap label">ကဒ်အရေအတွက်:</p></td>
                <td class="td-reduce-padding w-100"><input class="w-250" type="text" name="unit_count"></td>
              </tr>
              <tr class="table-column label-mb">
                <td class="td-reduce-padding "><p class="text-nowrap label">ဗူးအရေအတွက် :</p></td>
                <td class="td-reduce-padding w-100"><input class="w-250" type="text" name="pieces_count"></td>
              </tr>
              <tr class="table-column label-mb">
                <td class="td-reduce-padding "><p class="text-nowrap label">ဝယ်ဈေး :</p></td>
                <td class="td-reduce-padding w-100"><input class="w-50" type="text" name="purchase_price">
              ...
              <tr class="table-column label-mb">
                ...
                <td class="td-reduce-padding w-100"><input class="w-50" type="text" name="money_rate">
                    <select name="ငွေဈေးနှုန်း" id="cars" class="w-20">
              ...
              <tr class="table-column label-mb">
                ...
                <td class="td-reduce-padding w-100"><input class="w-250" type="text" name="deli_fee"></td>
              </tr>
              <tr class="table-column label-mb">
                <td class="td-reduce-padding "><p class="text-nowrap label">ဖာလိုက်လက်ကျန်:</p></td>
                <td class="td-reduce-padding w-100"><input class="w-250" type="text" name="p_totalcount" ></td>
              </tr>
              <tr class="table-column label-mb">
                <td class="td-reduce-padding "><p class="text-nowrap label">ကဒ်လိုက်လက်ကျန်:</p></td>
                <td class="td-reduce-padding w-100"><input class="w-250" type="text" name="c_totalcount"></td>
              </tr>
              <tr class="table-column label-mb">
                <td class="td-reduce-padding "><p class="text-nowrap label">ဗူးလိုက်လက်ကျန်:</p></td>
                <td class="td-reduce-padding w-100"><input class="w-250" type="text" name="b_totalcount"></td>
              </tr>
              <tr class="table-column label-mb">
                <td class="td-reduce-padding "><p class="text-nowrap label">ကုန်ဆုံးရက် :</p></td>
                <td class="td-reduce-padding w-100"><input class="w-250" type="date" name="expire_date"></td>
              </tr>
              <tr class="table-column label-mb">
                <td class="td-reduce-padding "><p class="text-nowrap label">အမြတ် :</p></td>
                <td class="td-reduce-padding w-100"><input class="w-250" type="text" name="profit"></td>
              </tr>
            ...
            <div class="d-md-flex justify-content-between align-items-center mb-3 mt-2">
              <div>
                ...
                <div class="pr-3 pl-3 pb-3 w-sm-100 w-lg-50"><button type="button" class="btn btn-primary btn-sm submit" name="update">ပြင်ရန်</button></div>
              </div>
              <div>
...
if ($result) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<tr>
                ...
                <td>' . htmlspecialchars($unit_count) . '</td>
                <td>' . htmlspecialchars($buy) . '</td>
                <td>' . htmlspecialchars($package_price) . '</td>
