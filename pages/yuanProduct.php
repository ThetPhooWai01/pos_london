...
<head>
  ...
  <title>London Shop | ယွမ်ပစ္စည်းစာရင်း</title>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="kyatProduct.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>ကျပ်ငွေ အရောင်း</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="bahtProduct.php" class="nav-link ">
                      <i class="far fa-circle nav-icon"></i>
                      <p>ဘတ်ငွေ အရောင်း</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="yuanProduct.php" class="nav-link active">
                      <i class="far fa-circle nav-icon"></i>
                      <p>ယွမ် အရောင်း</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="addCustomer.php" class="nav-link active">
                      <i class="far fa-circle nav-icon"></i>
                      <p>ဖောက်သည်သစ်ပေါင်းထည့်ရန်</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="bigcustomer.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="credit.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-header mb-0">
      <div class="container-fluid">
        <div class="row mb-2 d-flex flex-column align-items-between">
          <div class=" mb-4 mx-2">
            <h1 class="m-0">ယွမ်ဖြင့် ပစ္စည်းစာရင်းများကြည့်ရန်</h1>
          </div><!-- /.col -->
