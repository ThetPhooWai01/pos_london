        ...
        while($row = $result->fetch_assoc()) {
            ...
            if ($result && $result->num_rows > 0) {
              while ($row = $result->fetch_assoc()) {
                  ...
                  $customer = str_replace("\b", "", $customer);

          
                  $stmt = $connection->prepare("INSERT INTO `$user_id` (product_name, price, qty, total, tra_id, type,voucher,customer,discount,buy_type) VALUES (?,?, ?, ?, ?, ?, ?,?,?,?)");
                  $stmt->bind_param("ssssssssss", $product_name, $pieces_price, $qty, $pieces_price, $random, $type,$orderNumber,$customer,$discount,$buy_type);
            ...
            $stmt->bind_param("ssssssssssssss", $today, $barcode, $product_name, $pieces_price, $qty, $pieces_price, $random, $customer, $payment, $type, $date, $orderNumber,$discount,$buy_type);
        ...
        <div class="form-res">
          <form id="dataForm">
            ...
            <tr class="table-column label-mb">
                ...
                <td class="td-reduce-padding w-100"><input class="w-250" type="text" name="barcode" id="barcode" oninput="sendData()" autofocus></td>         
              </tr>
              ...
              if ($result->num_rows > 0) {
                ...
                <td class="td-reduce-padding w-100"><input class="w-250" type="text" name="rate"  id="orderNumber"  value="'.$last_voucher.'"></td>         
              </tr>
              ...
              <tr class="table-column label-mb">
                ...
                <td class="td-reduce-padding w-100"><input class="w-250" type="text" name="discount" id="discount"></td>         
              </tr>
              ...
              <tr class="table-column label-mb">
                ...
                <td class="td-reduce-padding w-100"><input class="w-250" type="date" name="date" id="date"></td>         
              </tr>

              <tr class="table-column label-mb">
                <td class="td-reduce-padding"><p class="text-nowrap label">Rate:</p></td>
                <td class="td-reduce-padding w-100"><input class="w-250" type="text" name="rate" id="rate"></td>         
              </tr>
            ...
            <script>
                ...
                button_print.addEventListener('click', function() {
                  window.location.href = 'index2_voucher.php';
                });
